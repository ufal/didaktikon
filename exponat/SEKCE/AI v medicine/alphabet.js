...
let content = {
    ...
    l_letter : {title: "Léky", text: "Vývoj léčiv je nákladná a zdlouhavá práce. Zde se ukazuje vhodné pole pro použití technik umělé inteligence. Na základě dostatečného množství dat mohou modely strojového učení navrhnout nadějnou molekulu, odhadnout vhodný výrobní proces, vytipovat reakce dané molekuly s ostatními látkami, posoudit vhodnost kombinace s jinými léčivy, nebo dokonce pro již známá léčiva navrhnout nové způsoby použití. To nic nemění na tom, že spousta práce s výrobou, testováním a schvalováním léčiv zůstane odborníkům, nicméně umělá inteligence by mohla urychlit nalézání nových molekul, nových výrobních procesů nebo aspoň nových indikací pro již známé látky. Některé fáze vývoje léčiv tak budou rychlejší a snadnější.", img: ""}, 
    m_letter : {title: "Mozek", text: "Mozek je jedním z klíčových orgánů našeho těla a dotýkáme se jej hned v několika kapitolách tohoto vzdělávacího modulu: umělá inteligence umí pomoci s Alzheimerovou chorobou, Parkinsonovou chorobou, cévními mozkovými příhodami a podobně.<br><br>Zde se zastavíme u nádorů mozku. Dobře natrénovaný model strojového učení dokáže automaticky „vyladit“ a vyčistit snímky zobrazovacích vyšetření (jako je CT, magnetická rezonance, PET-CT atd.), odhadnout typ případného nádoru a testuje se také možnost stanovení vhodné léčby a prognózy u pacienta s daným typem onemocnění. Samozřejmě stejně jako v jiných oblastech ani zde tyto odhady nevaří umělá inteligence „z vody“, ale při tvorbě modelu jí musíme poskytnout velké množství dostupných dat včetně snímků od mnoha a mnoha pacientů.", img: ""}, 
